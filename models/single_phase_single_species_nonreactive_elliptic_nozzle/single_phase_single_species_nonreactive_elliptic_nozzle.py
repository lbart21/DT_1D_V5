...
class SinglePhaseSingleSpeciesNonreactiveEllipticNozzle(SingleInlet1DMeshObject):
    __slots__ = []
    def __init__(self, geometry, n_cells, recon_scheme, limiter, recon_props, update_from, \
                        flux_scheme, init_flow_state, restart_flag, comp_label, \
    ...
    def initialise_interfaces(self, geometry, n_cells, init_flow_state, recon_scheme, limiter, \
