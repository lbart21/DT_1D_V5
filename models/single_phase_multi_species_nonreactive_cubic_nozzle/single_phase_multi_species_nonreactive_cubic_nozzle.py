...
class SinglePhaseMultiSpeciesNonreactiveCubicNozzle(SingleInlet1DMeshObject):
    __slots__ = []
    def __init__(self, n_cells, geometry, init_flow_state, restart_flag, flux_scheme, \
                        recon_scheme, limiter, recon_props, update_from, comp_label, \
