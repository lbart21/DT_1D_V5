...
class SinglePhaseMultiSpeciesFiniteRateReactivePipeWithMultipleInletsCell():
    __slots__ = ["cell_id", "label", "phase", "interior_cell_flag", "geo", "flow_state", \
                    "reactor_model", "dt_suggest", "cqs"]
