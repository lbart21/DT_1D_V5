...
class SinglePhaseMultiSpeciesNonuniformBulkReactionFastChemistryQuadraticNozzle(SingleInlet1DMeshObject):
    __slots__ = []

    def __init__(self, geometry, n_cells, init_flow_state, flux_scheme, recon_scheme, \
                        limiter, recon_props, update_from, bulk_reaction_parameters, \
