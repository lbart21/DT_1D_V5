...
from Algorithms.DT_1D_V5.models.interface_models.single_phase_single_species_constant_area_interface\
        import SinglePhaseSingleSpeciesConstantAreaInterface

class SinglePhaseSingleSpeciesNonreactivePipeWithMultipleInlets(MultiInlet1DMeshObject):
    __slots__ = []
    def __init__(self, n_cells, comp_label, n_inlets, inlet_areas, bulk_geometry, init_flow_state, \
                        restart_flag, recon_scheme, limiter, recon_props, update_from, \
    ...
    def initialise_cells(self, bulk_geometry, n_cells, init_flow_state, comp_label,\
                                 restart_flag):
        [D, L] = bulk_geometry
        for cell in range(n_cells):
            ...
            cell_object = SinglePhaseSingleSpeciesNonreactiveCell(\
    ...
    def initialise_interfaces(self, bulk_geometry, inlet_areas, n_cells, init_flow_state, \
        ...
        for inlet_ind, area in enumerate(inlet_areas):
            ...
            interface_object = SinglePhaseSingleSpeciesConstantAreaInterface(\
