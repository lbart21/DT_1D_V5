...
class SinglePhaseMultiSpeciesNonuniformBulkReactionFastChemistryEllipticNozzleCell():
    __slots__ = ["cell_id", "label", "geo", "flow_state", "phase", \
                    "interior_cell_flag", "cqs", "bulk_reaction_parameters", \
                    "massf_solver_matrices_been_formed", "LHS_A", "RHS_A", "source"]
