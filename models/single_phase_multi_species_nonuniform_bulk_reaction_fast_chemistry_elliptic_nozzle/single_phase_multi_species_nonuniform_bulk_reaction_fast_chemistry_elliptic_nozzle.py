...
class SinglePhaseMultiSpeciesNonuniformBulkReactionFastChemistryEllipticNozzle(SingleInlet1DMeshObject):
    __slots__ = []
    def __init__(self, geometry, n_cells, init_flow_state, flux_scheme, recon_scheme, \
                        limiter, recon_props, update_from, restart_flag, bulk_reaction_parameters, \
    ...
    def initialise_cells(self, geometry, n_cells,init_flow_state, restart_flag, \
                                comp_label, bulk_reaction_parameters):
        [_, _,  L] = geometry
