...
class SinglePhaseMultiSpeciesNonreactivePipeWithMultipleInlets(MultiInlet1DMeshObject):
    __slots__ = []
    def __init__(self, n_cells, n_inlets, inlet_areas, bulk_geometry, comp_label, \
                        init_flow_state, restart_flag, recon_scheme, limiter, recon_props, \
                        update_from, flux_scheme, reverse_direction_for_mirrored_flow = False) -> None:
    ...
    def initialise_cells(self, bulk_geometry, n_cells, init_flow_state, restart_flag, comp_label):
        ...
        for cell in range(n_cells):
            ...
            cell_object = SinglePhaseMultiSpeciesNonreactiveCell(\
