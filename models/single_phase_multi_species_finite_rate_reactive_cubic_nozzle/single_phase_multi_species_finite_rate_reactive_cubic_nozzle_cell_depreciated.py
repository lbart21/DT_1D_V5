...
class SinglePhaseMultiSpeciesFiniteRateReactiveCubicNozzleCell():
    __slots__ = ["cell_id", "label", "geo", "flow_state", "reactor_model", "phase", \
                    "interior_cell_flag", "dt_suggest", "cqs"]
