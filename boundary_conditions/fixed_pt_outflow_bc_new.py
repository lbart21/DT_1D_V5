...
Edits:
"""
def fixed_pt_outflow_bc(mesh, bc_ind):
    # bc = [interface_id, n_layers, str(West or East), ["FixedPTOutFlow_BC", gs], [(gc_id1, intc_id1), (gc_id2, intc_id2), ...]]
    ...
    for gc_id, intc_id in mesh.boundary_conditions[bc_ind][4]:
        ...
        mesh.cell_array[gc_id].flow_state.fluid_state.T = gs.T
        mesh.cell_array[gc_id].update_thermo_from_pT()
