...
def mdot_from_stagnation_inflow_bc(mesh, bc_ind):
    relaxation_factor = 0.1
    # bc = [interface_id, n_layers, str(West or East), ["FromStagnationWithMassFlowRateInFlow_BC", gs, mass_flux], [(gc_id1, intc_id1), (gc_id2, intc_id2), ...]]
    ...
    if mass_flux > 0.0:
        ...
        if abs(dp_over_p) < 0.001: # Allow min 0.1% change
